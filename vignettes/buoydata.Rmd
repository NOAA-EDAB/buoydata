...
```{r lazydata, echo = TRUE, eval = TRUE}
buoydata::buoy_data |> 
  dplyr::as_tibble()
```
...
```{r getvars, echo = TRUE, eval = FALSE}
buoydata::get_variables()
```
```{r displayvars, echo = FALSE, eval = TRUE}
buoydata:::vars
```
...
```{r searchData, echo = TRUE, eval = TRUE}
buoydata::buoy_data |> 
...
```{r internalbuoy, echo = FALSE, eval = TRUE}
buoy_44018 <- buoydata:::buoy_44018
```
